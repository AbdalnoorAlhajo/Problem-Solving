// #54 - Calculate Vacation Dates.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    cout << "\nActucal Vacation Day: " << CalculateVacationDays(DateFrom, DateTo) << endl;
